    ...
    <div class="row justify-content-between">
      <div class="col-lg-4 col-md-6 footer-widget footer-about">
        ...
        <!-- <img
          ...
          alt="Constra"
        /> -->
        <h1 style="color: white">Car Rentals</h1>
        <p>
      ...
      <div class="col-lg-3 col-md-6 mt-5 mt-lg-0 footer-widget">
        ...
        <ul class="list-arrow">
          <li><a href="service.html">Car Rentals</a></li>
          <li><a href="service.html">Fixing</a></li>
          <li>
            <a href="service.html">And so on</a>
          </li>
        </ul>
      </div>
      <!-- Col end -->
      ...
      <div class="col-md-6">
        <div class="copyright-info">
          <span
            ...
            <a href="https://opoweb.org">Opoweb</a></span
          >
        </div>
      </div>
